...
|---|---|---|---|
| [v8.1-2](https://github.com/web-brain/gentube-ffmpeg-mac/releases/tag/v8.1-2) | 8.1 | 2.x | mac arm64, gpl+lgpl. libunibreak+libmp3lame, 완전정적(dylib 0). v8.1-1은 dylib누출+mp3누락으로 폐기 |
